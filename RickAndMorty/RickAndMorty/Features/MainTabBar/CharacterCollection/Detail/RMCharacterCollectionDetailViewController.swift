...
final class RMCharacterCollectionDetailViewController: UIViewController {
    ...
    private let characterCollectionDetailView: RMCharacterCollectionDetailView
    ...
    init(characterCollectionDetailView: RMCharacterCollectionDetailView) {
        ...
        self.characterCollectionDetailView.viewModel.controller = self
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        characterCollectionDetailView.viewModel.onDismiss?()
    }
}
