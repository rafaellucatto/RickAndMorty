...
final class RMCharacterCollectionDetailView: UIView {
    ...
    private lazy var characterDetailCollection: UICollectionView = {
        let layout: UICollectionViewCompositionalLayout = UICollectionViewCompositionalLayout(sectionProvider: { sectionInt, _ in
