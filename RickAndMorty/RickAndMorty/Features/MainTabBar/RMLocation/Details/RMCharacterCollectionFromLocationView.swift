...
final class RMCharacterCollectionFromLocationView: UIView {
    ...
    let viewModel: RMCharacterCollectionFromLocationViewModel
    ...
    private lazy var characterCollection: UICollectionView = {
    ...
    init(viewModel: RMCharacterCollectionFromLocationViewModel) {
