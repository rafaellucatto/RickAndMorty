...
class NavigationBarViewModel: NSObject {
    ...
    var canShowPreviousPage: Bool {
        return previousPage != nil
    }

    var canShowNextPage: Bool {
        return nextPage != nil
    }
    ...
    var button: UIButton {
        ...
        if canShowPreviousPage {
            let previousPageAction: UIAction = UIAction(title: "Previous page",
        ...
        if canShowNextPage {
            let nextPageAction: UIAction = UIAction(title: "Next page",
        ...
        let searchPageAction: UIAction = UIAction(title: "Choose page",
    ...
    func setNavBarLeftSideTitle() {
        let pageCountLabel: UILabel = UILabel()
        pageCountLabel.text = "\(currentPage)/\(pageTotal)"
        pageCountLabel.sizeToFit()
        let leftButton: UIBarButtonItem = UIBarButtonItem(customView: pageCountLabel)
