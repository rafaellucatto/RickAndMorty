//
//  RMLocationPageChoosingView.swift
//  RickAndMortyUI
//
...
struct RMLocationPageChoosingView<ViewModel: RMLocationCollectionViewModelProtocol>: View {
            ...
            VStack(alignment: .center, spacing: 0) {
                HStack(alignment: .center, spacing: 0) {
                    ...
                    Picker("Chosen Page", selection: $chosenPage) {
                        ForEach(1...viewModel.lastPage, id: \.self) { num in
